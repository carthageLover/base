...
package utils
{
	...
	public class AnimButton extends Button
	{
		...
		{
			super(Texture.fromBitmapData(new BitmapData(Game.assets.getTexture("BOTONASOon0000").width, Game.assets.getTexture("BOTONASOon0000").height, true, 0)));
		...
		private function setButtonTextures():void
		{
			...
			mcHoverState = new MovieClip(Game.assets.getTextures("BOTONASOover"),24);
			mcHoverState.loop = false;
			Starling.juggler.add(mcHoverState);
			this.addChild(mcHoverState);			

			mcUpState = new MovieClip(Game.assets.getTextures("BOTONASOon"));
			mcUpState.loop = false;
			Starling.juggler.add(mcUpState);
			this.addChild(mcUpState);			
			
			mcDownState = new MovieClip(Game.assets.getTextures("BOTONASOdown"),24);
			mcDownState.loop = false;
			Starling.juggler.add(mcDownState);
			this.addChild(mcDownState);			
			
			mcOffState = new MovieClip(Game.assets.getTextures("BOTONASOoff"));
			mcUpState.loop = false;
			Starling.juggler.add(mcOffState);
			this.addChild(mcOffState);
			
			mcOutState = new MovieClip(Game.assets.getTextures("BOTONASOout"), 24);
